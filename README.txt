...
Notes:
TLDR - Recreating the game 2048 using JavaFX

Motivation - The problem is that there is not a fun enough, yet intellectually stimulating, game made with JavaFX.
